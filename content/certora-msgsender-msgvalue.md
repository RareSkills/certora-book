...
To verify the property: _“Only the owner can successfully call_ _`increment()`__”_, we write the following CVL rule:
...
![image](media/certora-msgsender-msgvalue/image-1b709cb3.png)
