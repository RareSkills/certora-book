...
We will cover most, but not all of the [Initializable.spec](https://github.com/OpenZeppelin/openzeppelin-contracts/blob/8ff78ffb6e78463f070eab59487b4ba30481b53c/fv/specs/Initializable.spec#L1-L176) file for OpenZeppelin, as some of the contents rely on techniques we haven't covered yet. However, the majority of the contents should be understandable based on what we have covered so far in the course.
